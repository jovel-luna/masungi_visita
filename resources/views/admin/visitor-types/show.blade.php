...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.visitor-types.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <visitor-types-view
                        fetch-url="{{ route('admin.visitor-types.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.visitor-types.update', $item->id) }}"
                        ></visitor-types-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.visitor-types', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
