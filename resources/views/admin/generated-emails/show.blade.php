...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.generated-emails.index') }}">Generated Emails</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.generated-emails.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        fetch-url="{{ route('admin.generated-emails.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.generated-emails.update', $item->id) }}"
                        :read-only="true"
                        ></generated-emails-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.generated-emails', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
