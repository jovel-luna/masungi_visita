...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.about-us.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <about-us-view
                        fetch-url="{{ route('admin.about-us.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.about-us.update', $item->id) }}"
                        ></about-us-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.about-us', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
