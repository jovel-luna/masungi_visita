...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.sources.index') }}">Sources</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.sources.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <source-view
                        fetch-url="{{ route('admin.sources.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.sources.update', $item->id) }}"
                        :read-only="true"
                        ></source-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.sources', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
