...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.agencies.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <agencies-view
                        fetch-url="{{ route('admin.agencies.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.agencies.update', $item->id) }}"
                        ></agencies-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.agencies', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
