        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Age Ranges</a></li>
                </ol>
            </div>
        </div>
    </section>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <age-ranges-table 
                            ref="table-1"
                            fetch-url="{{ route('admin.age-ranges.fetch') }}"
                            ></age-ranges-table>
                        </div>
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('admin.age-ranges.fetch-archive') }}"
                            ></age-ranges-table>
                        </div>
                    </div>
                </div>
