...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.age-ranges.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <age-range-view
                        fetch-url="{{ route('admin.age-ranges.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.age-ranges.update', $item->id) }}"
                        :read-only="true"
                        ></age-range-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.age-ranges', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
