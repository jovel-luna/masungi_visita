        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ str_limit($item->title, 15) }}</a></li>
                </ol>
            </div>
        </div>
    </section>
    
    <page-pagination fetch-url="{{ route('admin.training-modules.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        fetch-url="{{ route('admin.training-modules.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.training-modules.update', $item->id) }}"
                        :read-only="true"
                        ></training-modules-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.training-modules', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
