...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.experiences.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <experiences-view
                        fetch-url="{{ route('admin.experiences.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.experiences.update', $item->id) }}"
                        ></experiences-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.experiences', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
