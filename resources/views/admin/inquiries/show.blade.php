...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.inquiries.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <inquiries-view
                        fetch-url="{{ route('admin.inquiries.fetch-item', $item->id) }}"
                        ></inquiries-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.inquiries', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
