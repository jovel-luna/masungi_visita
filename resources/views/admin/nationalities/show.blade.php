...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.nationalities.index') }}">Nationalities</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.nationalities.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <nationality-view
                        fetch-url="{{ route('admin.nationalities.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.nationalities.update', $item->id) }}"
                        :read-only="true"
                        ></nationality-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.nationalities', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
