...
@section('meta:title', 'Nationalities')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Nationalities</a></li>
                </ol>
            </div>
        </div>
    </section>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <nationalities-table 
                            ref="table-1"
                            fetch-url="{{ route('admin.nationalities.fetch') }}"
                            ></nationalities-table>
                        </div>
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('admin.nationalities.fetch-archive') }}"
                            ></nationalities-table>
                        </div>
                    </div>
                </div>
