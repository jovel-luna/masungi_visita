...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.remarks.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <remarks-view
                        fetch-url="{{ route('admin.remarks.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.remarks.update', $item->id) }}"
                        :read-only="true"
                        ></remarks-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.remarks', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
