...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.violations.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <violations-view
                        fetch-url="{{ route('admin.violations.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.violations.update', $item->id) }}"
                        :read-only="true"
                        ></violations-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.violations', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
