...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.civil_statuses.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <civil_statuses-view
                        fetch-url="{{ route('admin.civil_statuses.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.civil_statuses.update', $item->id) }}"
                        :read-only="true"
                        ></civil_statuses-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.civil_statuses', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
