...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.conservation-fees.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        fetch-url="{{ route('admin.conservation-fees.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.conservation-fees.update', $item->id) }}"
                        :read-only="true"
                        ></conservation-fee-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.conservation-fees', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
