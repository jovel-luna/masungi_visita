...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('admin.conservation-fees.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <conservation-fees-table 
                            ref="table-1"
                            fetch-url="{{ route('admin.conservation-fees.fetch') }}"
                            ></conservation-fees-table>
                        </div>
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('admin.conservation-fees.fetch-archive') }}"
                            ></conservation-fees-table>
                        </div>
                    </div>
                </div>
