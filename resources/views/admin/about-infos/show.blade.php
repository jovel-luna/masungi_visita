...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.about-infos.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <about-infos-view
                        fetch-url="{{ route('admin.about-infos.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.about-infos.update', $item->id) }}"
                    ...
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.about-infos', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
