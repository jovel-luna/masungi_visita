...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">About Info</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        <div class="mb-4">
            <a href="{{ route('admin.about-infos.create') }}" class="btn btn-primary text-white">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <about-infos-table 
                        ref="table-1"
                        fetch-url="{{ route('admin.about-infos.fetch') }}"
                        ></about-infos-table>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        ref="table-2"
                        disabled
                        fetch-url="{{ route('admin.about-infos.fetch-archive') }}"
                        ></about-infos-table>
                    </div>
                    <div class="tab-pane" id="tab3">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.about-infos') }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
